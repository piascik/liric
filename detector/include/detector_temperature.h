...
extern int Detector_Temperature_Set_TEC_Setpoint(double setpoint_temperature_C);
...
extern int Detector_Temperature_Temp_To_DAC(double temperature_C,int *dac_value);
