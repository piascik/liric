/* detector_test_temperature_pcb_get.c */
/**
 * Test program to test retrieving the detector PCB temperature from the Raptor Ninox-640 camera head.
 ...
 * @see ../cdocs/detector_temperature.html#Detector_Temperature_PCB_Get
 */
int main(int argc, char *argv[])
{
	...
	/* parse arguments */
	fprintf(stdout,"detector_test_temperature_pcb_get : Parsing Arguments.\n");
	...
	fprintf(stdout,"detector_test_temperature_pcb_get : Initialising Detector library.\n");
	...
	/* get the detector PCB temperature. */
	...
	fprintf(stdout,"detector_test_temperature_pcb_get : Detector PCB temperature is %.3f degrees Centigrade.\n",temperature);
	...
	fprintf(stdout,"detector_test_temperature_pcb_get : Finished.\n");		
	return 0;
}
...
static void Help(void)
{
	fprintf(stdout,"Test Getting the detector PCB temperature:Help.\n");
	fprintf(stdout,"This program tests retrieving the detector PCB temperature from the Raptor Ninox-640 camera head.\n");
	fprintf(stdout,"detector_test_temperature_pcb_get [-coadd[_exposure_length] <ms>][-fmt[_directory] <dir>]\n");
