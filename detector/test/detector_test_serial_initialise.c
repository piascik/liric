...
/**
 * Test program to test the Raptor Ninox-640 XCLIB serial interface initialisation routine.
...
int main(int argc, char *argv[])
{
	...
	/* parse arguments */
	fprintf(stdout,"detector_test_serial_initialise : Parsing Arguments.\n");
	...
	fprintf(stdout,"detector_test_serial_initialise : Finished.\n");		
	return 0;
}
...
static void Help(void)
{
	...
	fprintf(stdout,"This program tests the Raptor Ninox-640 XCLIB serial interface initialisation routine.\n");
	fprintf(stdout,"detector_test_serial_initialise [-coadd[_exposure_length] <ms>][-fmt[_directory] <dir>]\n");
